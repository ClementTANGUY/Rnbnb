...
Flatpickr.l10ns = {
	en: {
		...
		months: {
			shorthand: ["Jan", "Fev", "Mar", "Avr", "Mai", "Ju", "Jui", "Aôu", "Sep", "Oct", "Nov", "Dec"],
			longhand: ["Janvier", "Fevrier", "Mars", "Avril", "Mai", "Juin", "Juillet", "Aôut", "Septembre", "Octobre", "Novembre", "Decembre"]
		},
		daysInMonth: [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31],
		firstDayOfWeek: 0,
		ordinal: function ordinal(nth) {
			var s = nth % 100;
			if (s > 3 && s < 21) return "ème";
			switch (s % 10) {
				case 1:
					return "er";
				case 2:
